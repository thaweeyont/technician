...
//
//     final jobLogAddress = jobLogAddressFromJson(jsonString);

import 'dart:convert';

List<JobLogAddress> jobLogAddressFromJson(String str) =>
    List<JobLogAddress>.from(
        json.decode(str).map((x) => JobLogAddress.fromJson(x)));

String jobLogAddressToJson(List<JobLogAddress> data) =>
...
class JobLogAddress {
  ...
  factory JobLogAddress.fromJson(Map<String, dynamic> json) => JobLogAddress(
