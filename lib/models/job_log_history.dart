...
//
//     final jobLogHistory = jobLogHistoryFromJson(jsonString);

import 'dart:convert';

List<JobLogHistory> jobLogHistoryFromJson(String str) =>
    List<JobLogHistory>.from(
        json.decode(str).map((x) => JobLogHistory.fromJson(x)));

String jobLogHistoryToJson(List<JobLogHistory> data) =>
...
class JobLogHistory {
  ...
  factory JobLogHistory.fromJson(Map<String, dynamic> json) => JobLogHistory(
