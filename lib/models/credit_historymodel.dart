...
//
//     final creditHistory = creditHistoryFromJson(jsonString);

import 'dart:convert';

List<CreditHistory> creditHistoryFromJson(String str) =>
    List<CreditHistory>.from(
        json.decode(str).map((x) => CreditHistory.fromJson(x)));

String creditHistoryToJson(List<CreditHistory> data) =>
