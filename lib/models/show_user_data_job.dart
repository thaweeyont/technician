...
//
//     final userDataJob = userDataJobFromJson(jsonString);

import 'dart:convert';

List<UserDataJob> userDataJobFromJson(String str) => List<UserDataJob>.from(
    json.decode(str).map((x) => UserDataJob.fromJson(x)));

String userDataJobToJson(List<UserDataJob> data) =>
...
class UserDataJob {
  ...
  factory UserDataJob.fromJson(Map<String, dynamic> json) => UserDataJob(
